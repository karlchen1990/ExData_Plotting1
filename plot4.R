...
legend(1170369049.60,60,c("Sub_Metering_1","Sub_Metering_2","Sub_Metering_3"),text.col=c("black","red","blue"),lwd = 0.5,cex=0.75,col=c("black","red","blue"),text.width = 32531.48,y.intersp = 0.1,bty = 'n')
