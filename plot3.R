...
plot(hh_select$Time,hh_select$Sub_metering_1,type = "l",col="black")
...
legend("topright",c("Sub_Metering_1","Sub_Metering_2","Sub_Metering_3"),text.col=c("black","red","blue"),lwd = 1,col=c("black","red","blue"))
